...
package protobuf.SensorReading
...
final case class SensorReading(
    ...
    def withSensorId(__v: _root_.scala.Int): SensorReading = copy(sensorId = __v)
    ...
    def companion: protobuf.SensorReading.SensorReading.type = protobuf.SensorReading.SensorReading
    // @@protoc_insertion_point(GeneratedMessage[protobuf.SensorReading])
}

object SensorReading extends scalapb.GeneratedMessageCompanion[protobuf.SensorReading.SensorReading] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[protobuf.SensorReading.SensorReading] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): protobuf.SensorReading.SensorReading = {
    ...
    protobuf.SensorReading.SensorReading(
        sensorId = __sensorId,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protobuf.SensorReading.SensorReading] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SensorReadingProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SensorReadingProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = protobuf.SensorReading.SensorReading(
    sensorId = 0,
    timestamp = 0L,
    temperature = 0.0f,
    humidity = 0.0f
  )
  implicit class SensorReadingLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, protobuf.SensorReading.SensorReading]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, protobuf.SensorReading.SensorReading](_l) {
  ...
  ): _root_.protobuf.SensorReading.SensorReading = _root_.protobuf.SensorReading.SensorReading(
    sensorId,
    timestamp,
    temperature,
    humidity
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[protobuf.SensorReading])
}
