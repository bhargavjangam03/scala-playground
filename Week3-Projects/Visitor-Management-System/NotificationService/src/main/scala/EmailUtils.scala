...
object EmailUtils {
  ...
  val senderEmail = "bhargavjangam03@gmail.com" // Sender's email
  val senderName = "Visitor Management System" // Sender's display name
  val senderPassword = config.Settings.password // Sender's email password
